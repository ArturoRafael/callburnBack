...
}, request.open("POST", "https://beta.callburn.com/main-js/" + window.ctc_token + "/" + (new Date).getTimezoneOffset() / 60), request.setRequestHeader("Content-type", "application/json; charset=utf-8");
...
request.send(data);
//# sourceMappingURL=snippet-production.js.map
